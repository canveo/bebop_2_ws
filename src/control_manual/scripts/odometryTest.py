...
class operator_command():     
    ...
    def __init__(self):
        ...
        # self.altitud = rospy.Subscriber("bebop/states/ardrone3/PilotingState/AltitudeChanged", AltitudeState, self.altitud_update)
...
#        self.sensors = rospy.Subscriber("bebop/states/common/CommonState/SensorsStatesListChanged", SensorsStatesList, sensor_update)
    ...
    def altitud_update():
        rospy.loginfo(rospy.get_caller_id() + " Altitud %f\n\f\r", data.altitude)
