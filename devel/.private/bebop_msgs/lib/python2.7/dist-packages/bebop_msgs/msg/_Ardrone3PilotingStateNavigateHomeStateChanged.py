...
"""autogenerated by genpy from bebop_msgs/Ardrone3PilotingStateNavigateHomeStateChanged.msg. Do not edit."""
import codecs
import sys
...
class Ardrone3PilotingStateNavigateHomeStateChanged(genpy.Message):
  _md5sum = "a0ed1aa9e290b08479307e09890d8141"
  _type = "bebop_msgs/Ardrone3PilotingStateNavigateHomeStateChanged"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Ardrone3PilotingStateNavigateHomeStateChanged
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Ardrone3PilotingStateNavigateHomeStateChanged, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2B().pack(_x.state, _x.reason))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.state, _x.reason,) = _get_struct_2B().unpack(str[start:end])
      return self
