...
"""autogenerated by genpy from bebop_msgs/CommonFlightPlanStateComponentStateListChanged.msg. Do not edit."""
import codecs
import sys
...
class CommonFlightPlanStateComponentStateListChanged(genpy.Message):
  _md5sum = "61463ac9d27f6b9f7cbcf76649da9cd3"
  _type = "bebop_msgs/CommonFlightPlanStateComponentStateListChanged"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# CommonFlightPlanStateComponentStateListChanged
...
"""
  ...
  __slots__ = ['header','component','State']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CommonFlightPlanStateComponentStateListChanged, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2B().pack(_x.component, _x.State))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.component, _x.State,) = _get_struct_2B().unpack(str[start:end])
      return self
