...
"""autogenerated by genpy from bebop_msgs/Ardrone3MediaRecordStateVideoResolutionState.msg. Do not edit."""
import codecs
import sys
...
class Ardrone3MediaRecordStateVideoResolutionState(genpy.Message):
  _md5sum = "478002c2ec614a227f494865922fd580"
  _type = "bebop_msgs/Ardrone3MediaRecordStateVideoResolutionState"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Ardrone3MediaRecordStateVideoResolutionState
...
"""
  ...
  __slots__ = ['header','streaming','recording']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Ardrone3MediaRecordStateVideoResolutionState, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2B().pack(_x.streaming, _x.recording))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.streaming, _x.recording,) = _get_struct_2B().unpack(str[start:end])
      return self
