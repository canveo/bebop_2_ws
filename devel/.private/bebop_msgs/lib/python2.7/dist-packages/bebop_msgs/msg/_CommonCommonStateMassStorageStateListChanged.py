...
"""autogenerated by genpy from bebop_msgs/CommonCommonStateMassStorageStateListChanged.msg. Do not edit."""
import codecs
import sys
...
string frame_id
"""
  __slots__ = ['header','mass_storage_id','name']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.mass_storage_id,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
