...
"""autogenerated by genpy from bebop_msgs/CommonCommonStateVideoRecordingTimestamp.msg. Do not edit."""
import codecs
import sys
...
string frame_id
"""
  __slots__ = ['header','startTimestamp','stopTimestamp']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,startTimestamp,stopTimestamp
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2Q().pack(_x.startTimestamp, _x.stopTimestamp))
