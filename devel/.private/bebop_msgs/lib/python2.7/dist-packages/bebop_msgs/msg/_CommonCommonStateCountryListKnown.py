...
"""autogenerated by genpy from bebop_msgs/CommonCommonStateCountryListKnown.msg. Do not edit."""
import codecs
import sys
...
string frame_id
"""
  __slots__ = ['header','listFlags','countryCodes']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.listFlags,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.countryCodes = str[start:end].decode('utf-8', 'rosmsg')
      else:
